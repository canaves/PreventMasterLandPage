export const company = {
  ...
  serviceAreas: ["Londrina - PR", "Cambé - PR", "Ibiporã - PR", "Rolândia - PR"],
  serviceRegionText:
    "Atendemos Londrina e região (Cambé, Ibiporã, Rolândia e cidades próximas) na região Norte do Paraná.",
  businessHours: [
